...
class Formulario extends Controller
{
            ...
            switch ($val->tipo) {
                ...
                case 'select':
                    if (isset($formulario_opc)) {
                        ...
                        foreach ($formulario_opc as $op) {
                            $respostas .= '<option value="' . $op->opcao . '">' . $op->opcao . '</option>';
                        }
    ...
    public function submeter(Request $request)
    {
        ...
        $email_auto = \DB::table('email_auto')->get();
        ...
        foreach ($formulario as $val) {
            ...
            if ($val->obrigatorio && empty($resposta)) {
                return 'Existem campos obrigatórios por preencher.';
            }
        ...
        if (empty($termos)) {
            return 'Deve concordar com a utilização dos dados.';
        }
